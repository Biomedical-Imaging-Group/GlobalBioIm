...
text(-5,pos(1),['x=',num2str(pos(1))],'FontSize',14,'HorizontalAlignment','right')
text(pos(2),-7,['y=',num2str(pos(2))],'FontSize',14,'HorizontalAlignment','center')
text(sz(2)+margin+pos(3),-7,['z=',num2str(pos(3))],'FontSize',14,'HorizontalAlignment','center')
text(-5,sz(1)+margin+pos(3),['z=',num2str(pos(3))],'FontSize',14,'HorizontalAlignment','right')
