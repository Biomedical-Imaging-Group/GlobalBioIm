function Orthoviews(im,pos,newfig)
%% function Orthoviews(im,pos,newfig)
%
...
text(pos(2),-5,['J=',num2str(pos(2))],'FontSize',14,'HorizontalAlignment','center')
text(sz(2)+margin+pos(3),-5,['K=',num2str(pos(3))],'FontSize',14,'HorizontalAlignment','center')
